...
echo -e "${GREEN}✓${NC} Created services/user/.env"
...
echo -e "${GREEN}✓${NC} Created services/product/.env"
...
echo -e "${GREEN}✓${NC} Created services/order/.env"
...
echo -e "${GREEN}✓${NC} Created services/payment/.env"
